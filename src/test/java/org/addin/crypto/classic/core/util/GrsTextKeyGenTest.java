 ...
 */
public class GrsTextKeyGenTest {
    
    public GrsTextKeyGenTest() {
    }
    ...
    /**
     * Test of shuffling method, of class GrsTextKeyGen.
     */
    @Test
    public void testShuffling() {
        System.out.println("generateMatrixByText");
        String text = "reformation";
        GrsTextKeyGen instance = new GrsTextKeyGen(16, text);
        // expResult from TextKeyGenTest
        ...
        assertThat(result, IsNot.not(IsEqual.equalTo(expResult)));
    }
